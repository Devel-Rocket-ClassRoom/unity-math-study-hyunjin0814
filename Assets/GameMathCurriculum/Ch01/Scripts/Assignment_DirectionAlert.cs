...
public class Assignment_DirectionAlert : MonoBehaviour
{
    ...
    {
        // 외적을 계산하면 좌, 우, 전/후방을 찾을 수 있음
        // 전/후방을 서로 구분할 때에는 내적에서 각도가 90을 넘어갔거나, 그래프를 통한 수치가 음수 일때 후방으로 인식
        ...
        Vector3 cross = Vector3.Cross(transform.forward, toTarget.normalized); // 매개변수 순서 중요 (나로부터 타겟)
