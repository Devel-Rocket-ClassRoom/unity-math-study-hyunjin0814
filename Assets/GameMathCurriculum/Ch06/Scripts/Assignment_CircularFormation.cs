...
public class Assignment_CircularFormation : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < units.Length; i++)
        {
            ...
            //relativeRot = Quaternion.AngleAxis(angle, Vector3.up);

            //// TODO
            //Quaternion formationRot = leader.rotation * relativeRot;
            //Vector3 offset = formationRot * Vector3.forward * formationRadius;

            //// TODO
            //units[i].position = leader.position + offset;
            //units[i].rotation = formationRot;
        }
