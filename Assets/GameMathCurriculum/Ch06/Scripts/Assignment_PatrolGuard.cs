...
public class Assignment_PatrolGuard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //// TODO
        //targetRotation = Quaternion.FromToRotation(Vector3.forward, dirToNext);
        ...
        Vector3 get = new Vector3(target.position.x, 0f, target.position.z);

        distanceToNext = Vector3.Distance(transform.position, get);
